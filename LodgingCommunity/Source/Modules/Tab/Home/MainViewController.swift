...
class MainViewController: UITableViewController, MainCellDelegate {
    ...
    func bindOutlet() {
        vm.pagingData.bind(to: (self.tableView?.rx.items(cellIdentifier: "LodgingCell", cellType: MainCell.self))!) { (row, element, cell) in
